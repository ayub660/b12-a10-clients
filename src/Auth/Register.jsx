    ...
    return (
        <div className="min-h-[70vh] flex justify-center items-center">
            <form onSubmit={handleSubmit} className="bg-white p-6 shadow-md rounded w-96">
                ...
                <button type="submit" className="w-full bg-green-600 text-white py-2 rounded mb-2">Register</button>
                <button type="button" onClick={handleGoogle} className="w-full bg-blue-500 text-white py-2 rounded mb-2">Register with Google</button>
